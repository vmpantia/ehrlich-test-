...
namespace PizzaPlace.Core.Commands.Handlers
{
    public class PizzaCommandHandlers :
        IRequestHandler<ImportPizzasByCSVFileCommand, Result>
    {
        ...
        public async Task<Result> Handle(ImportPizzasByCSVFileCommand request, CancellationToken cancellationToken)
        {
            ...
            return Result.Success("Pizzas imported successfully to the database.");
        }
    }
}
